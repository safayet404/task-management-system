    ...
    <div className='px-4'>
        <Popover className="relative">
          ...
          >
            ...
            <Popover.Panel className="absolute lef-1/2 z-10 mt-3 w-90 max-w-sm -translate-x-1/2 transform px-4 sm:px-0">

            <div className='flex items-center gap-4 rounded-lg shadow-lg bg-white p-4'>

                <div className='w-16 h-16 bg-blue-600 rounded-full text-white justify-center text-2xl'>
                    <span>
                        {getInitials(user?.name)}
                    </span>
                </div>
