    ...
    <div>
        <Menu as="div" className="relative inline-block text-left">
            ...
            leaveTo='transform opacity-0 scale-95'
             >
                <Menu.Items className="absolute right-0 mt-2 w-56 origin-top-right divide-gray-100 rounded-md bg-white shadow-2xl ring-1
                    ...
                    <div className='p-4'>
                        ...
                        <Menu.Item>
                            {({active})=>(
                                ...
                                '>
                                    <FaUserLock className='mr-2' aria-hidden='true'  /> Change Password
                                </button>
                            )}
                        </Menu.Item>
                        <Menu.Item>
                            {({active})=>(
                                <button onClick={logoutHandler} className='text-red-700 group flex w-full items-center rounded-md px-2 py-2 text-base
                                '>
