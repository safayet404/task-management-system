          ...
          <div className="w-full flex flex-col md:flex-row gap-5 2xl:gap-8 bg-white shadow-md p-8 overflow-y-auto">
            <div className="w-full md:w-1/2 space-y-0">
              <div className="flex items-center gap-5">
                <div className={clsx("flex gap-1 items-center text-base font-semibold px-3 py-1 rounded-full", bgColor?.high)}>
              ...
              <div className="space-y-8">
                <p className="text-gray-500">SUB-TASKS</p>
            ...
            <div className="w-full md:w-1/2 space-y-0">
              ...
              <div className="w-full grid grid-cols-2 gap-4">
                {task?.assets?.map((el, index) => (
                  <img key={index} src={el} alt={task?.title} className="w-full rounded h-28 md:h-36 2xl:h-52 cursor-pointer transition-all duration-700 hover:scale-125 hover:z-50" />
                ))}
              </div>
    ...
    return (
      <div className="flex space-x-4">
        ...
        <div className="flex flex-col gap-y-1 mb-8">
          ...
          <div className="text-gray-500 space-y-2  space-x-1">
